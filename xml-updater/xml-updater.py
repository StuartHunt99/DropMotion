...
def add_clips_to_sequence(xml_file, json_file, output_file, scale_increment=150):
    ...
    last_end_frame = 0  # To keep track of the end frame of the last clip
    ...
    for idx, clip in enumerate(clips_data):
        ...
        duration_seconds = 10  # Assuming each clip duration is 10 seconds

        start_frame = int(start_time_seconds * timebase)
        duration_frames = int(duration_seconds * timebase)

        # Adjust start_frame to prevent overlap
        ...
        # Get image dimensions and calculate initial scale
        ...
        ET.SubElement(new_clipitem, 'duration').text = str(duration_frames)
        ...
        ET.SubElement(new_clipitem, 'out').text = str(duration_frames)
        ...
        # Add Basic Motion filter with scale keyframes
        filter_element = ET.SubElement(new_clipitem, 'filter')
        ...
        ET.SubElement(keyframe2, 'when').text = str(duration_frames)
